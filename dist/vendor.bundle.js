...
var myDirective = exports.myDirective = _angular2.default.module("directives", []).directive('myDirective', [function () {
	return {
		restrict: 'E',
...
var app = exports.app = _angular2.default.module("MyApp", ['directives']).run();
console.log(app);
